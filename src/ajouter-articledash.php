            ...
            <div class="max-w-[800px] w-full max-h-[500px] bg-white rounded-lg shadow-lg overflow-y-scroll ">
                ...
                <div class="mb-6">
                    ...
                    <div class="mb-6">
                        ...
                        <textarea class="appearance-none border border-gray-400 rounded-lg w-full py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent" id="contrnue" name="contrnue" type="text" placeholder="contenue" required></textarea>
